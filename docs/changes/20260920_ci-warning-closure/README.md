...
| --- | --- | --- | --- | --- |
| AC1 | All first-party, HashiCorp, AWS credential, and Docker action references use current Node-24-compatible supported majors; container-based Appleboy actions and already-current ECR v2 remain unchanged. | T1,T4 | repository action inventory and remote annotations | Not started |
