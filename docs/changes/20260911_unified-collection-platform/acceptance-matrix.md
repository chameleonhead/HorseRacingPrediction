...
| New queue cutover and old queue/data deletion | Verified | Production apply 34698106395 removed the legacy main queue/DLQ and old mapping, connected Lambda and IAM to the resource-collection queue, and a recovered production task reached Attempt 1 through SQS/Lambda. Legacy job DB/code removal was verified in the earlier replacement checkpoint. |
