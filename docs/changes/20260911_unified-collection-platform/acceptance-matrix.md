...
| Manual/bulk operations and projections | Verified | Seven typed selectors, preview drift rejection, transactional rollback, management projections and the replacement Blazor UI are tested. |
