...
/// </summary>
internal sealed class JraRaceResultUrlDiscoverer
{
    ...
    public const string AgentName = "JraRaceResultUrlDiscoverer";

    private readonly IWebBrowser _browser;
    private readonly ILogger<JraRaceResultUrlDiscoverer> _logger;

    public JraRaceResultUrlDiscoverer(IWebBrowser browser, ILogger<JraRaceResultUrlDiscoverer>? logger = null)
    {
        _browser = browser;
        _logger = logger ?? NullLogger<JraRaceResultUrlDiscoverer>.Instance;
    }
