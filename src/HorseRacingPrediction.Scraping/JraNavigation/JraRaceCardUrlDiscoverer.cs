...
/// </summary>
internal sealed class JraRaceCardUrlDiscoverer
{
    ...
    private readonly ILogger<JraRaceCardUrlDiscoverer> _logger;

    public JraRaceCardUrlDiscoverer(IWebBrowser browser, ILogger<JraRaceCardUrlDiscoverer>? logger = null)
    {
        _browser = browser;
        _logger = logger ?? NullLogger<JraRaceCardUrlDiscoverer>.Instance;
    }
