...
public sealed class PlaywrightPageSnapshotter : IPageSnapshotter
{
    ...
    private static PageSnapshot Convert(BrowserSnapshot dto)
    {
        ...
        return new PageSnapshot
        {
            ...
            Tables = dto.Tables.Select(ConvertTable).ToArray(),
    ...
    private static PageTableSnapshot ConvertTable(BrowserTable dto)
        => new()
        {
    ...
    private sealed record BrowserTableCell(string Text, bool IsHeader, int RowSpan, int ColumnSpan);
