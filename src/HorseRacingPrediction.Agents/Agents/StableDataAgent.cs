...
{
    internal const string AgentName = "StableDataAgent";
    ...
    internal const string SystemPrompt = """
        ...
        ## 行動方針
        - `FetchTrainerStats` で netkeiba の調教師成績ページを取得する
        - `SearchAndFetch` で「調教師名 成績」「厩舎名 管理馬」などを検索して補完する
        - `FetchPageContent` で JRA 公式の調教師情報ページを取得する（必要な場合）
